...
3. Explain that `com.actionfit.ai-codeconvention@0.5.2` owns the stable `AFCC-*` rules, including `AFCC-PCR-001`, while AI Refactor owns deterministic candidate inventory and evidence-backed proposal orchestration.
