...
3. Explain that `com.actionfit.ai-codeconvention@0.4.2` owns the stable `AFCC-*` rules while AI Refactor owns only deterministic candidate inventory and evidence-backed proposal orchestration.
