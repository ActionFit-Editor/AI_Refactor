...
public static class AIRefactorPackageMenu
{
    private const string MenuRoot = "Tools/Package/AI Refactor/";
    private const string ReadmePath = "Packages/com.actionfit.ai-refactor/README.md";
